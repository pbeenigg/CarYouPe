...
export function AdminHeader() {
  ...
  const avatarUrl =
    user?.avatar_url ||
    `https://api.dicebear.com/9.x/avataaars/svg?seed=${user?.username || "guest"}`;
          ...
          {loading ? (
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="relative h-10 flex items-center gap-3 rounded-full pl-0 hover:bg-transparent"
                >
